  ...
  return (
    <div className="w-[338px] overflow-hidden font-sans text-sm flex">
      ...
      <div className="w-[calc(100%-106px)] px-[16px]">
        <div className="font-semibold text-base text-gray-700 truncate">
          {hotel?.hotelName?.length > 17
            ? `${hotel?.hotelName?.slice(0, 17)}...`
            : hotel.hotelName}
        </div>
        ...
        <div className="flex items-start gap-2 mt-[10px]">
          <span className="w-[29px] h-[17px] flex items-center justify-center rounded-[12px] bg-[#29AF52] text-[12px] text-[#ffffff] font-[600]">
            {hotel?.hotelRating}
          </span>
        ...
        <div className="w-full h-full flex justify-between mt-[10px]">
          <div>
            <h3 className="text-[#4B4D4D] text-[16px] font-[700]">
              {hotel?.currency} {hotel.total}
            </h3>
            <span className="text-[#6B6B6B] text-[12px] font-[400] mt-[-5px] inline-block">
              per night
            </span>
          </div>
          <div className="w-auto text-right">
            <Button
              fullWidth={false}
              className="rounded-[8px] h-[31px] w-[115px] text-[10px] px-[10px] py-[10px] flex items-center justify-center"
            >
              Check Availability
            </Button>
          </div>
