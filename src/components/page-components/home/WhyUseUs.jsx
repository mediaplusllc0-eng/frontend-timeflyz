...
function WhyUseUs() {
    return (
        <div className='px-[16px] md:px-[30px] w-full'>
            <div className='w-full h-auto bg-[#FED1C7] rounded-[20px] px-[20px] md:px-[40px] py-[40px] pb-[55px] md:py-[60px] md:pb-[60px]'>
                <div className='flex justify-between flex-wrap md:flex-nowrap gap-[40px] md:gap-20'>
                    <div className='w-full md:w-[50%] md:text-left'>
                        <h2 className='md:text-left text-[40px] md:text-[55px] text-[#4B4D4D] font-[700]'>Why use us for hotel booking?</h2>
                        <p className='md:text-left text-[16px] text-[#4B4D4D] font-[400] mt-[16px]'>Whatever your business, we’re your little black book of trusted big holiday hotels.</p>
                        <Button fullWidth={false} className="text-md w-[191px] h-[60px] rounded-[12px] mt-[30px]">
                            Search hotels
                        </Button>
                    </div>

                    <div className='w-full md:w-[60%] flex flex-wrap gap-y-[40px] md:gap-y-[60px] justify-between md:gap-x-[20px]'>
                        <div className='md:text-left md:w-[47%]'>
