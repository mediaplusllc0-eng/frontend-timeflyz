...
function WhyUseUs() {
    return (
        <div className='px-[30px] w-full'>
            <div className='w-full h-auto bg-[#FED1C7] rounded-[20px] px-[40px] py-[60px]'>
                <div className='flex justify-between gap-20'>
                    <div className='w-[50%]'>
                        <h2 className='text-[55px] text-[#4B4D4D] font-[700]'>Why use us for hotel booking?</h2>
                        <p className='text-[16px] text-[#4B4D4D] font-[400] mt-[16px]'>Whatever your business, we’re your little black book of trusted big holiday hotels.</p>
                        <Button fullWidth={false} className="text-md capitalize w-[191px] h-[60px] rounded-[12px] mt-[30px]">
                            Search hotels
                        </Button>
                    </div>

                    <div className='w-[60%] flex flex-wrap gap-y-[60px] justify-between gap-x-[20px]'>
                        <div className='w-[47%]'>
