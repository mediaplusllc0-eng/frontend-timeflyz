...
function UseCases() {
    return (
        <section className="px-[16px] md:px-[30px] md:py-[80px] py-[80px]">
            <h5 className="text-[16px] text-[#4B4D4D] font-[400] mb-[16px]">Use cases</h5>
            <h2 className="text-[40px] md:text-[55px] font-[700] text-[#4B4D4D] mb-[40px] tracking-normal">
                More than you can imagine
            </h2>

            <div className='flex items-center justify-between flex-wrap md:flex-nowrap'>
                <div className='w-full md:w-[32%] mb-[40px] md:mb-0'>
            ...
            <div className='bg-[#E4E4E4] h-[260px] md:h-[280px] rounded-[20px] mt-5 md:mt-[80px] flex items-center justify-center flex-col'>
                <h5 className='text-[16px] text-[#4B4D4D] font-[400]'>Hire amazing manor hotels</h5>
                <h2 className='text-[40px] md:text-[55px] text-[#4B4D4D] font-[700] mt-[16px]'>
                    <span className='flex items-center gap-4 mb-5 md:mb-0'>
                        for
                        <img className='w-[43px] md:w-auto' alt='timeflyz' src='/img/forBusiness.png' />
                    ...
                    <span className='flex items-center gap-4'>
                        and
                        <img className='w-[43px] md:w-auto' alt='timeflyz' src='/img/forHolidays.png' />
                        <span className='underline'>
                            <Link href="#">
                                holidays
                            </Link>
