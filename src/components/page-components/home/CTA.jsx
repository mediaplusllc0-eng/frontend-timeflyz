...
function CTA() {
    return (
        <div className='px-[16px] md:px-[30px] md:py-[80px] py-[80px]'>
            <div className='relative w-full md:h-[280px] bg-[#FED1C7] rounded-[20px] p-[20px] py-[40px] pb-[112px] md:p-[40px] flex justify-between items-center flex-wrap md:flex-nowrap'>
                <h2 className='relative text-[#4B4D4D] text-[40px] md:text-[55px] font-[700] w-fit'>
                    Enjoy your <br /> exclusive offers
                    <svg className='w-auto absolute md:top-[-40px] top-[-50px] right-[-80px]' width="126" height="126" viewBox="0 0 126 126" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='md:pr-[63px] w-full md:w-auto'>
                    <p className='md:relative text-[20px] text-[#000] font-[400]'>
                        Discover our exclusive offers in advance by<br className='hidden md:block' /> subscribing to our newsletter
                        <svg className='block absolute bottom-0 md:top-[-40px] md:right-[-80px] left-[100px] md:left-auto' width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex-wrap md:flex-nowrap flex items-center md:gap-[10px] gap-[16px] md:mt-[15px] mt-[20px] '>
