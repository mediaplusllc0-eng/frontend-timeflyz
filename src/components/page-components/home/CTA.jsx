...
function CTA() {
    return (
        <div className='px-[30px] py-[80px]'>
            <div className='w-full h-[280px] bg-[#FED1C7] rounded-[20px] p-[40px] flex justify-between items-center'>
                <h2 className='relative text-[#4B4D4D] text-[55px] font-[700] w-fit'>
                    Enjoy your <br /> exclusive offers
                    <svg className='absolute top-[-40px] right-[-80px]' width="126" height="126" viewBox="0 0 126 126" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='pr-[63px]'>
                    <p className='relative text-[20px] text-[#000] font-[400]'>
                        Discover our exclusive offers in advance by<br /> subscribing to our newsletter
                        <svg className='absolute top-[-40px] right-[-80px]' width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex items-center gap-[10px] mt-[15px]'>
                        <div className="inputDiv flex flex-col rounded-[12px] bg-[#fff] py-[12px] px-[16px] w-[334px] h-[60px]">
                        ...
                        <Button fullWidth={false} className="mx-auto text-md capitalize w-[163px] h-[60px] rounded-[12px]">
                            Subscribe
                        </Button>
                    </div>
                </div>
