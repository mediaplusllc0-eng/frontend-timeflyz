...
function Reviews() {
    ...
    return (
        <div className='px-[30px] reviewsmain'>
            <div className='flex justify-between items-end'>
                <div>
                    <h2 className="text-[55px] font-[700] text-[#4B4D4D] mb-[16px] tracking-normal">
                        Satisfied customers in <br /> over 29 countries
                    </h2>
                    <h5 className="text-[16px] text-[#4B4D4D] font-[400]">People who have tried daytime hotels have not been disappointed. Read about<br /> their experiences!</h5>
                </div>
                <div>
                    <img src="/img/trustpilot-logo.png" />
                    <img src="/img/trustpilot_5_stars.png" className='mt-[10px]' />
            ...
            <div className="sliderDiv w-full mx-auto mt-[40px] px-[30px]">
                <Slider infinite autoplay autoplaySpeed={2000} pauseOnHover={false} {...settings}>
                    <div className="text-black overflow-visible">
                        <div className='p-[30px] w-[97%] h-[322px] shadow-[0_4px_50px_rgba(0,0,0,0.25)] bg-white rounded-[20px] flex flex-col justify-between'>
