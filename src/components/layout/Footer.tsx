        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 px-5">
          ...
          <div>
            ...
            <address className="text-[#4B4D4D] not-italic space-y-3">
              ...
              <div className="flex items-center">
                <EmailIcon className="h-5 w-5 mr-3 text-primary-600" />
          ...
          <div>
            ...
            <div className="flex rounded-xl bg-white">
              <input
                ...
                className="px-5 py-2 w-full focus:border-none outline-none text-black rounded-l-xl"
              />
              <button className="bg-primary-600 hover:bg-gold-600 px-4 py-4 rounded-r-xl transition duration-300">
