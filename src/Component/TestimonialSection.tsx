...
export default function TestimonialSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden mb-5 bg-[#E7EAEA]">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <Image src="/img/testi.jpg" alt="Mountain view deck" fill className="object-cover" priority />
      </div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row min-h-[500px] lg:min-h-[600px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 bg-gray-900 p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center md:mx-0 mx-auto my-8 sm:my-10 md:my-12">
          ...
          <h3 className="text-white text-xs sm:text-sm uppercase tracking-wider mb-3 sm:mb-4 font-[Lora]">AT THE HEART OF COMMUNITIES</h3>

          <h2 className="text-white text-2xl sm:text-3xl md:text-4xl font-light mb-6 sm:mb-8 font-[Lora]">People Say</h2>

          <blockquote className="text-white italic mb-6 sm:mb-8 text-base sm:text-lg font-[Lora]">{currentTestimonial.quote}</blockquote>
          ...
          <div className="flex items-center">
            ...
            <div>
              <p className="text-white font-medium text-sm sm:text-base font-[Lora]">{currentTestimonial.author}</p>
              <p className="text-white opacity-80 text-xs sm:text-sm font-[Lora]">{currentTestimonial.location}</p>
            </div>
          </div>
